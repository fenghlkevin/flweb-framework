...
import cn.com.cennavi.kfgis.framework.annotation.CustomParamProcessor;
import cn.com.cennavi.kfgis.framework.annotation.ICustomParamProcessor;
...
public abstract class AbstractParams implements IParams {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.com.cennavi.kfgis.bean.param.IParams#setPostValues(byte[])
	 */
	@Override
