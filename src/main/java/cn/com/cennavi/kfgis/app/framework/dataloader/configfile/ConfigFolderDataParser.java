package cn.com.cennavi.kfgis.app.framework.dataloader.configfile;
...
import cn.com.cennavi.kfgis.framework.file.impl.AbstractFileDataParser;
...
public class ConfigFolderDataParser extends AbstractFileDataParser<Map<String, ConfigFile>> {
	...
	/* (non-Javadoc)
	 * @see cn.com.cennavi.kfgis.framework.file.impl.AbstractFileDataParser#isNewFile(java.lang.String)
