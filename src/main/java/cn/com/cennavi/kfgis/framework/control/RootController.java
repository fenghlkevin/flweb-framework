package cn.com.cennavi.kfgis.framework.control;
...
import cn.com.cennavi.kfgis.framework.annotation.ReturnObject;
    ...
    public static void loadRootControllers(ClassLoader sysloader) {
        ...
        try {
            for (File f : files) {
                ...
                cn.com.cennavi.kfgis.framework.annotation.RootController rootC = clazz
                        .getAnnotation(cn.com.cennavi.kfgis.framework.annotation.RootController.class);
                if (rootC == null) {
                    continue;
                }
