...
// * <p>Title: WEB-T GIS核心系统_XX服务_空结果异常返回130101</p>
...
// * @update 修改日期 修改描述
// */
//public class EmptyResultException extends BaseServiceException {
//	/**
//	 * 
//	 */
...
//	 */
//	public EmptyResultException(ObjectError error) {
//		super();
//		this.error = error;
//	}
//
...
//	 */
//	public EmptyResultException(String message, ObjectError error) {
//		super(message);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public EmptyResultException(String message, Throwable cause, ObjectError error) {
//		super(message, cause);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public EmptyResultException(Throwable cause, ObjectError error) {
//		super(cause);
//		this.error = error;
//	}
//
