...
public abstract class AbstractReflectionConverter implements Converter, Caching {
    ...
    protected void doMarshal(final Object source, final HierarchicalStreamWriter writer, final MarshallingContext context) {
        ...
        new Object() {
                ...
                for (Iterator fieldIter = fields.iterator(); fieldIter.hasNext();) {
                    ...
                    if (info.value != null) {
                        ...
                        if (mapping != null) {
                            ...
                            for (Iterator iter = isArray ? new ArrayIterator(info.value) : isCollection ? ((Collection) info.value).iterator()
                                    : isEntry ? ((Map) info.value).entrySet().iterator() : ((Map) info.value).values().iterator(); iter.hasNext();) {
                                ...
                                if (obj == null) {
                                    ...
                                    final String entryName = mapping.getItemFieldName() != null ? mapping.getItemFieldName() : mapper
            ...
            void writeField(String fieldName, String aliasName, Class fieldType, Class definedIn, Object newObj) {
                ExtendedHierarchicalStreamWriterHelper.startNode(writer, aliasName != null ? aliasName : mapper.serializedMember(source.getClass(), fieldName),
                        fieldType);
                ...
                if (newObj != null) {
                    ...
                    if (!actualType.equals(defaultType)) {
                        ...
                        if (!serializedClassName.equals(mapper.serializedClass(defaultType))) {
                            ...
                            //MAKESOURCE fenghl edit //&&!"class".equalsIgnoreCase(attributeName)
                            if (attributeName != null && !"class".equalsIgnoreCase(attributeName)) {
                                //MAKESOURCE fenghl edit
    ...
    public Object doUnmarshal(final Object result, final HierarchicalStreamReader reader, final UnmarshallingContext context) {
        ...
        while (reader.hasMoreChildren()) {
            ...
            boolean fieldExistsInClass = implicitCollectionMapping == null && reflectionProvider.fieldDefinedInClass(fieldName, fieldDeclaringClass);
            Class type = implicitCollectionMapping == null || implicitCollectionMapping.getItemType() == null ? determineType(reader, fieldExistsInClass,
                    result, fieldName, classDefiningField) : implicitCollectionMapping.getItemType();
            final Object value;
            if (fieldExistsInClass) {
    ...
    private Map writeValueToImplicitCollection(UnmarshallingContext context, Object value, Map implicitCollections, Object result, String itemFieldName) {
        String fieldName = mapper
                .getFieldNameForItemTypeAndName(context.getRequiredType(), value != null ? value.getClass() : Mapper.Null.class, itemFieldName);
        if (fieldName != null) {
                ...
                if (physicalFieldType.isArray()) {
                    ...
                    if (!(Collection.class.isAssignableFrom(fieldType) || Map.class.isAssignableFrom(fieldType))) {
                        throw new ObjectAccessException("Field " + fieldName + " of " + result.getClass().getName()
                                + " is configured for an implicit Collection or Map, but field is of type " + fieldType.getName());
                    }
            ...
            throw new ConversionException("Element " + itemFieldName + " of type " + value.getClass().getName() + " is not defined as field in type "
    ...
    private class MappingList extends AbstractList {
        ...
        public boolean add(Object object) {
            ...
            throw new ConversionException("Element of type " + object.getClass().getName() + " is not defined as entry for map of type "
