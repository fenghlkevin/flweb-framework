package com.kevin.iesutdio.kfgis.web.framework.exception.service;
 ...
 * @update 修改日期 修改描述
 */
public class VersionInformationException extends NBaseServiceException {
    
    {
        this.setStatusCode(150800);
    }
     ...
     */
    public VersionInformationException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public VersionInformationException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
