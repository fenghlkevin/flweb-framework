 ...
 * @update 修改日期 修改描述
 */
public class MetaDataPoiTypeException extends NBaseServiceException {
    
    {
        this.setStatusCode(150902);
    }
     ...
     */
    public MetaDataPoiTypeException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public MetaDataPoiTypeException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
