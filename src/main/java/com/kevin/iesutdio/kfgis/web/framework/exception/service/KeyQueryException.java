 ...
 * @update 修改日期 修改描述
 */
public class KeyQueryException extends NBaseServiceException {
    
    {
        this.setStatusCode(150301);
    }
     ...
     */
    public KeyQueryException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public KeyQueryException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
