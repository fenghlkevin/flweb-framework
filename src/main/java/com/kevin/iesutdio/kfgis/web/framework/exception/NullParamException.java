...
// * <p>Title: WEB-T GIS核心系统_XX服务_空值校验结果</p>
...
// * @update 修改日期 修改描述
// */
//public class NullParamException extends BaseServiceException {
//	/**
//	 * 
//	 */
...
//	 */
//	public NullParamException(ObjectError error) {
//		super();
//		this.error = error;
//	}
//
...
//	 */
//	public NullParamException(String message, ObjectError error) {
//		super(message);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public NullParamException(String message, Throwable cause, ObjectError error) {
//		super(message, cause);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public NullParamException(Throwable cause, ObjectError error) {
//		super(cause);
//		this.error = error;
//	}
//
