...
// * <p>Title: WEB-T GIS核心系统_基础服务_最基础的服务，不用来直接输出判断</p>
...
//	 */
//	public BaseServiceException(ObjectError error) {
//		super();
//		this.error = error;
//	}
//
...
//	 */
//	public BaseServiceException(String message, ObjectError error) {
//		super(message);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public BaseServiceException(String message, Throwable cause, ObjectError error) {
//		super(message, cause);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public BaseServiceException(Throwable cause, ObjectError error) {
//		super(cause);
//		this.error = error;
//	}
//
