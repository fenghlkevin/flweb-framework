 ...
 * @update 修改日期 修改描述
 */
public class StaticDataQueryException extends NBaseServiceException {
    
    {
        this.setStatusCode(150900);
    }
     ...
     */
    public StaticDataQueryException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public StaticDataQueryException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
