 ...
 * @update 修改日期 修改描述
 */
public class AdminByPointException extends NBaseServiceException {
    
    {
        this.setStatusCode(150304);
    }
     ...
     */
    public AdminByPointException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public AdminByPointException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
