 ...
 * @update 修改日期 修改描述
 */
public class MetaDataAdminException extends NBaseServiceException {
    
    {
        this.setStatusCode(150901);
    }
     ...
     */
    public MetaDataAdminException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public MetaDataAdminException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
