...
// * <p>Title: WEB-T GIS核心系统_公共服务_服务内部错误，只需要返回码值以及错误描述</p>
...
// * @update 修改日期 修改描述
// */
//public class ServiceInternalException extends BaseServiceException {
//	/**
//	 * 
//	 */
...
//	 */
//	public ServiceInternalException(ObjectError error) {
//		super();
//		this.error = error;
//	}
//
...
//	 */
//	public ServiceInternalException(String message, ObjectError error) {
//		super(message);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public ServiceInternalException(String message, Throwable cause, ObjectError error) {
//		super(message, cause);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public ServiceInternalException(Throwable cause, ObjectError error) {
//		super(cause);
//		this.error = error;
//	}
//
