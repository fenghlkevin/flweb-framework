...
// * <p>Title: WEB-T GIS核心系统_XX服务_错误的参数校验结果 返回400错误</p>
...
// * @update 修改日期 修改描述
// */
//public class InvalidParamException extends BaseServiceException {
//	/**
//	 * 
//	 */
...
//	 */
//	public InvalidParamException(ObjectError error) {
//		super();
//		this.error = error;
//	}
//
...
//	 */
//	public InvalidParamException(String message, ObjectError error) {
//		super(message);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public InvalidParamException(String message, Throwable cause, ObjectError error) {
//		super(message, cause);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public InvalidParamException(Throwable cause, ObjectError error) {
//		super(cause);
//		this.error = error;
//	}
//
