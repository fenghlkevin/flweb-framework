 ...
 * @update 修改日期 修改描述
 */
public class EncryptionEngineException extends NBaseServiceException {
    
    {
        this.setStatusCode(150500);
    }
     ...
     */
    public EncryptionEngineException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public EncryptionEngineException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
