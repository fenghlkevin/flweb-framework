 ...
 * @update 修改日期 修改描述
 */
public class NEmptyResultException extends NBaseServiceException {
    
    {
        this.setStatusCode(130101);
    }
     ...
     */
    public NEmptyResultException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public NEmptyResultException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
    
    public NEmptyResultException(long errorCode,String message) {
        super(message);
        this.setStatusCode(errorCode);
        this.setStatusMsg(message);
    }
    
    public NEmptyResultException(long errorCode,String message, Throwable cause) {
        super(message,cause);
        this.setStatusCode(errorCode);
        this.setStatusMsg(message);
    }
