...
// * <p>Title: WEB-T GIS核心系统_公共服务_返回500错误</p>
...
// * @update 修改日期 修改描述
// */
//public class ServiceCommonException extends BaseServiceException {
//	/**
//	 * 
//	 */
...
//	 */
//	public ServiceCommonException(ObjectError error) {
//		super();
//		this.error = error;
//	}
//
...
//	 */
//	public ServiceCommonException(String message, ObjectError error) {
//		super(message);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public ServiceCommonException(String message, Throwable cause, ObjectError error) {
//		super(message, cause);
//		this.error = error;
//	}
//
...
//	 * @since 1.4
//	 */
//	public ServiceCommonException(Throwable cause, ObjectError error) {
//		super(cause);
//		this.error = error;
//	}
//
