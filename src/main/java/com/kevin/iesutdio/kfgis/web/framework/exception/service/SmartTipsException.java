 ...
 * @update 修改日期 修改描述
 */
public class SmartTipsException extends NBaseServiceException {
    
    {
        this.setStatusCode(150305);
    }
     ...
     */
    public SmartTipsException(String message) {
        super(message);
     ...
     * @since  1.4
     */
    public SmartTipsException(String message, Throwable cause) {
        super(message, cause);
        this.setStatusMsg(message);
    }
