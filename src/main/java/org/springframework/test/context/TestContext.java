...
public class TestContext extends AttributeAccessorSupport {
    ...
    TestContext(Class<?> testClass, ContextCache contextCache, String defaultContextLoaderClassName) {
        ...
        if (contextConfiguration == null) {
            ...
            //fengheliang add
            String springParams=System.getProperty(SystemContextListener.CONTEXTCONFIGLOCATION);
            if(springParams!=null&&!"".equalsIgnoreCase(springParams)){
                locations=new String[]{springParams};
            }
            //fengheliang add end
