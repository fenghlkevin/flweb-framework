...
public class SpringJUnit4ClassRunner extends BlockJUnit4ClassRunner {
    ...
    private void initwebList() {
        ...
        String file = System.getProperty("user.dir") + "/src/main/webapp/WEB-INF/web.xml";
        ...
        try {
            ...
            if (params != null) {
                for (int i = 0; i < params.getLength(); i++) {
                    ...
                    if (!SystemContextListener.PARAM_ROOTCONFIG.equalsIgnoreCase(name)) {
                        continue;
                    }

                    String value = doc.getElementsByTagName("param-value").item(i).getFirstChild().getNodeValue();
                    System.setProperty(SystemContextListener.PARAM_ROOTCONFIG, value);
