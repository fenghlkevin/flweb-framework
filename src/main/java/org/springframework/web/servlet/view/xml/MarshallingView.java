...
public class MarshallingView extends AbstractView {
    ...
    protected void renderMergedOutputModel(Map model, HttpServletRequest request, HttpServletResponse response)
        ...
        if(temp instanceof String){
            ...
            bos.write(tempStr.getBytes("UTF-8"));
            request.setAttribute(FrameworkGISContants.CONTANT_RESONSE_ATTRIBUTE, tempStr);
        }else{
            bos.write(xmlHead.getBytes());
        ...
        request.setAttribute(FrameworkGISContants.CONTANT_RESONSE_ATTRIBUTE, bos.toByteArray());
